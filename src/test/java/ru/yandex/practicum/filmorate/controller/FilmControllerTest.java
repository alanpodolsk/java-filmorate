...
class FilmControllerTest {
    ...
    void shouldCreateFilm() {
        //Act
        Film createdFilm = filmController.createFilm(new Film(1, "синее солнце джунглей", "фильммм", LocalDate.of(2000, 1, 1), 50, new HashSet<>(), new HashSet<>(), new HashSet<>(), new MPA()));
        //Assert
    ...
    void shouldThrownValidationExceptionWhenNameIsBlank() {
        ...
        ValidationException ex = Assertions.assertThrows(
                ValidationException.class,
                () -> filmController.createFilm(new Film(1, "", "фильммм", LocalDate.of(2000, 1, 1), 50, new HashSet<>(), new HashSet<>(), new HashSet<>(), new MPA()))
        );
        //Assert
    ...
    void shouldThrownValidationExceptionWhenDescriptionIsTooLong() {
        ...
        ValidationException ex = Assertions.assertThrows(
                ValidationException.class,
                () -> filmController.createFilm(new Film(1, "синее солнце джунглей", "фильммм".repeat(1000), LocalDate.of(2000, 1, 1), 50, new HashSet<>(), new HashSet<>(), new HashSet<>(), new MPA()))
        );
        //Assert
    ...
    void shouldThrownValidationExceptionWhenReleaseDateTooEarly() {
        ...
        ValidationException ex = Assertions.assertThrows(
                ValidationException.class,
                () -> filmController.createFilm(new Film(1, "синее солнце джунглей", "фильммм", LocalDate.of(1800, 1, 1), 50, new HashSet<>(), new HashSet<>(), new HashSet<>(), new MPA()))
        );
        //Assert
    ...
    void shouldThrownValidationExceptionWhenDurationIsNegative() {
        ...
        ValidationException ex = Assertions.assertThrows(
                ValidationException.class,
                () -> filmController.createFilm(new Film(1, "синее солнце джунглей", "фильммм", LocalDate.of(2000, 1, 1), -50, new HashSet<>(), new HashSet<>(), new HashSet<>(), new MPA()))
        );
        //Assert
    ...
    void shouldGet2Films() {
        //Arrange
        Film createdFilm1 = filmController.createFilm(new Film(1, "синее солнце джунглей", "фильммм", LocalDate.of(2000, 1, 1), 50, new HashSet<>(), new HashSet<>(), new HashSet<>(), new MPA()));
        Film createdFilm2 = filmController.createFilm(new Film(1, "синее солнце джунглей", "фильммм", LocalDate.of(2000, 1, 1), 50, new HashSet<>(), new HashSet<>(), new HashSet<>(), new MPA()));
        //Act
    ...
    void shouldUpdateFilm() {
        ...
        filmController.createFilm(new Film(1, "синее солнце джунглей", "фильммм", LocalDate.of(2000, 1, 1), 50, new HashSet<>(), new HashSet<>(), new HashSet<>(), new MPA()));
        //Act
        Film updatedFilm = filmController.updateFilm(new Film(1, "синее солнце джунглей", "фильммм", LocalDate.of(2000, 1, 1), 50, new HashSet<>(), new HashSet<>(), new HashSet<>(), new MPA()));
        //Assert
    ...
    void shouldThrownNoObjectExceptionWhenIdIsIncorrect() {
        ...
        RuntimeException ex = Assertions.assertThrows(
                ...
                () -> filmController.updateFilm(new Film(1, "синее солнце джунглей", "фильммм", LocalDate.of(2000, 1, 1), 50, new HashSet<>(), new HashSet<>(), new HashSet<>(), new MPA()))
        );
        //Assert
